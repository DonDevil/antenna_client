...
class ChatMessageHandler:
    ...
    def handle_feedback_submission(self, feedback_values: dict[str, Any]):
        ...
        payload = {
            ...
            "actual_center_frequency_ghz": feedback_values["actual_center_frequency_ghz"],
            "actual_bandwidth_mhz": feedback_values["actual_bandwidth_mhz"],
            "actual_return_loss_db": -18.0,
            "actual_vswr": feedback_values["actual_vswr"],
            "actual_gain_dbi": feedback_values["actual_gain_dbi"],
            "artifacts": {
                "s11_trace_ref": f"artifacts/s11_iter{self.iteration_index}.json",
                "summary_metrics_ref": f"artifacts/summary_iter{self.iteration_index}.json",
                "farfield_ref": None,
