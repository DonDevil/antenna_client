...
- Processing error responses according to handoff error codes
"""

from typing import Dict, Any, Optional
from pydantic import BaseModel, ValidationError
from comm.error_handler import ErrorHandler, ErrorCode, ErrorRecovery
...
class ResponseHandler:
    ...
    def handle_optimize_response(self, response: OptimizeResponse) -> Dict[str, Any]:
        ...
        if response.status in ("accepted", "completed") and response.command_package:
            ...
            # Use ErrorHandler to parse error details
            if response.error:
                error_code, user_msg, recoverable, action = ErrorHandler.parse_error(response.error)
                ...
                result["suggested_action"] = "retry_operation"
